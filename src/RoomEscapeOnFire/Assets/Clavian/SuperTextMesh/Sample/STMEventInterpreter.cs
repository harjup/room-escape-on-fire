...
public class STMEventInterpreter : MonoBehaviour {
	...
	public void DoEvent(string s, TextInfo info){ //the string from the event, index of the letter in the string, world position of this letter, position of bottom-left corner
